...
class Component$1 {
    ...
    renderRoot() {
        return this.elementVNode = this.render(createNode$1);
    }
    getElementVNode() {
...
class ComponentVNode extends VNode {
    ...
    init() {
        ...
        if (Constructor.prototype) {
            ...
            this.component = Constructor(props, children);
        }
        if (this.component instanceof Component$1) {
...
class ElementVNode extends VNode {
    ...
    getRealNode(child) {
        ...
        else if (child instanceof Component$1) { // 待删除
...
function initVNode(baseNode) {
    ...
    if (typeof baseNode === "string") {
        ...
        // 这里判断是类组件还是函数式组件
        if (component instanceof Component$1)
            component.renderRoot().createEle();
        else if (component instanceof ElementVNode)
            component.createEle();
        return baseNode;
    }
...
function createNode$1(nodeTag, props, children) {
