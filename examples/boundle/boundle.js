...
(function (global, factory) {
  ...
  */
  ...
  })(exports.VNODE_TYPE || (exports.VNODE_TYPE = {}));
  ...
  function isVNode(content) {
      return isObject(content) && content.flag in exports.VNODE_TYPE;
  }
  ...
  function isVArrayNode(node) {
      return node.flag === exports.VNODE_TYPE.ARRAYNODE;
  }
  function isVTextNode(node) {
      return node.flag === exports.VNODE_TYPE.TEXT;
  }
  function isVElementNode(node) {
      return node.flag === exports.VNODE_TYPE.ELEMENT;
  }
  function isVFragmentNode(node) {
      return node.flag === exports.VNODE_TYPE.FRAGMENT;
  }
  function isVComponentNode(node) {
      return node.flag === exports.VNODE_TYPE.COMPONENT;
  }
  function isVAliveNode(node) {
      return node.flag === exports.VNODE_TYPE.ALIVE;
  }
  ...
  */
  ...
  function definePlugin(appPlugin) {
      return appPlugin;
  }
  ...
  */
  ...
  function renderElement(tag, props, children) {
      return {
          type: tag,
          flag: exports.VNODE_TYPE.ELEMENT,
          props,
          children
      };
  }
  function renderFragment(children) {
      return {
          type: FragmentSymbol,
          flag: exports.VNODE_TYPE.FRAGMENT,
          children
      };
  }
  function renderArrayNode(children) {
      return {
          type: ArraySymbol,
          flag: exports.VNODE_TYPE.ARRAYNODE,
          children
      };
  }
  ...
  function renderComponent(component, props, children) {
      ...
      if (component.prototype &&
          ...
          let vc = {
              ...
              children: children,
              flag: exports.VNODE_TYPE.COMPONENT,
  ...
  */
  ...
  function getNextSibling(vNode) {
      switch (vNode.flag) {
          case exports.VNODE_TYPE.TEXT:
          case exports.VNODE_TYPE.ELEMENT:
          case exports.VNODE_TYPE.ARRAYNODE:
          case exports.VNODE_TYPE.FRAGMENT:
              return vNode.el.nextSibling;
          case exports.VNODE_TYPE.COMPONENT:
              return vNode.root.el.nextSibling;
          case exports.VNODE_TYPE.ALIVE:
  ...
  function patch(oldVNode, newVNode, container, app) {
      ...
      if (isSameVNode(oldVNode, newVNode)) {
          ...
          if (flag === exports.VNODE_TYPE.TEXT) {
              patchText(oldVNode, newVNode);
          }
          else if (flag === exports.VNODE_TYPE.ARRAYNODE) {
  ...
  function VNodeInsertBefore(container, node, next) {
      if (node.flag === exports.VNODE_TYPE.ELEMENT || node.flag === exports.VNODE_TYPE.TEXT) {
          container.insertBefore(node.el, next);
      }
      else if (node.flag === exports.VNODE_TYPE.COMPONENT) {
          container.insertBefore(node.root.el, next);
      }
      else if (node.flag === exports.VNODE_TYPE.ARRAYNODE || node.flag === exports.VNODE_TYPE.FRAGMENT) {
